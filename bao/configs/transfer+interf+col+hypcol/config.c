...
VM_IMAGE(tx, "../../guests/comm/transfer/tx/build/zcu104-BAO/baremetal.bin");
VM_IMAGE(rx, "../../guests/comm/transfer/rx/build/zcu104-BAO/baremetal.bin");
